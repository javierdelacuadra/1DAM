...
public abstract class Cliente implements Clonable<Cliente> {
    ...
    private final List<List<LineaCompra>> comprasAntiguas;
    ...
    public Cliente(String dni, String nombre, Set<Monedero> monederos, List<LineaCompra> carrito, List<List<LineaCompra>> comprasAntiguas) {
        this.dni = dni;
        this.nombre = nombre;
